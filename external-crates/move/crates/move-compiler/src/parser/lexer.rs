...
impl<'input> Lexer<'input> {
            ...
            if text.starts_with("/*") {
                ...
                loop {
                    ...
                    if text.is_empty() {
                        ...
                        // otherwise.
                        let location = make_loc(self.file_hash, loc.0, loc.0 + if loc.1 { 3 } else { 2 });
                        ...
                        if loc.1 {
                            ...
                            self.doc_comments
                                .insert((loc.0 as u32, end as u32), self.text[(loc.0 + 3)..(end - 2)].to_string());
                        }
    ...
    // documentation.
    pub fn check_and_get_doc_comments(&mut self, env: &mut CompilationEnv) -> MatchedFileCommentMap {
