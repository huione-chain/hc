...
async fn test_recovery() {
    ...
    for last_executed_certificate_index in 0..consensus_index_counter {
        ...
        assert!(consensus_output[0].len() >= (num_of_committed_certificates - last_executed_certificate_index) as usize);
    }
}
...
async fn test_internal_consensus_output() {
    ...
    for i in 0..NUM_OF_TRANSACTIONS {
        ...
        let txn = TransactionProto { transactions: vec![Bytes::from(tr)] };
