...
impl TransactionBuilder {
    ...
    pub async fn upgrade_tx_kind(
        ...
        let capability_owner =
            upgrade_capability.owner.ok_or_else(|| anyhow!("Unable to determine ownership of upgrade capability"))?;
        let pt = {
            let mut builder = ProgrammableTransactionBuilder::new();
    ...
    pub async fn upgrade(
        ...
        let upgrade_cap = self
            ...
            .into_object()?;
        let cap_owner =
            upgrade_cap.owner.ok_or_else(|| anyhow!("Unable to determine ownership of upgrade capability"))?;
