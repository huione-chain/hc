...
use sui_tls::Allower;
use sui_types::{bridge::BridgeSummary, sui_system_state::sui_system_state_summary::SuiSystemStateSummary};
...
async fn extract_bridge(summary: BridgeSummary, metrics_keys: MetricsPubKeys) -> Vec<(Ed25519PublicKey, AllowedPeer)> {
    {
