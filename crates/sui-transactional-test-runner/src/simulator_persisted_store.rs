...
impl ObjectStore for PersistedStore {
    fn get_object(&self, object_id: &ObjectID) -> Result<Option<Object>, sui_types::storage::error::Error> {
...
impl ObjectStore for PersistedStoreInnerReadOnlyWrapper {
    fn get_object(&self, object_id: &ObjectID) -> sui_types::storage::error::Result<Option<Object>> {
        self.sync();
    ...
    fn get_object_by_key(
        ...
        Ok(self.inner.objects.get(object_id).expect("Fatal: DB read failed").and_then(|x| x.get(&version).cloned()))
    }
}

impl ReadStore for PersistedStoreInnerReadOnlyWrapper {
    fn get_committee(&self, _epoch: EpochId) -> sui_types::storage::error::Result<Option<std::sync::Arc<Committee>>> {
        todo!()
    }
    ...
    fn get_checkpoint_contents_by_digest(
        ...
        Ok(self.inner.checkpoint_contents.get(digest).expect("Fatal: DB read failed"))
    }
    ...
    fn get_transaction_effects(
        ...
        Ok(self.inner.effects.get(tx_digest).expect("Fatal: DB read failed"))
    }
    ...
    fn get_events(
        ...
        Ok(self.inner.events.get(event_digest).expect("Fatal: DB read failed"))
    }

    fn get_full_checkpoint_contents_by_sequence_number(
        &self,
        _sequence_number: CheckpointSequenceNumber,
    ) -> sui_types::storage::error::Result<Option<sui_types::messages_checkpoint::FullCheckpointContents>> {
        todo!()
    }
...
impl RestStateReader for PersistedStoreInnerReadOnlyWrapper {
    ...
    fn get_chain_identifier(&self) -> sui_types::storage::error::Result<sui_types::digests::ChainIdentifier> {
        Ok((*self.get_checkpoint_by_sequence_number(0).unwrap().unwrap().digest()).into())
    }
    ...
    ) -> sui_types::storage::error::Result<Box<dyn Iterator<Item = sui_types::storage::AccountOwnedObjectInfo> + '_>>
    {
        todo!()
    }
    ...
    fn dynamic_field_iter(
        ...
        Box<dyn Iterator<Item = (sui_types::storage::DynamicFieldKey, sui_types::storage::DynamicFieldIndexInfo)> + '_>,
    > {
        todo!()
    }
