...
impl StoredEpochInfo {
    pub fn from_epoch_beginning_info(e: &IndexedEpochInfo) -> Self {
        Self {
            ...
            system_state_summary_json: Some(serde_json::to_value(e.system_state_summary.clone()).unwrap()),
    ...
    pub fn from_epoch_end_info(e: &IndexedEpochInfo) -> Self {
        Self {
            ...
            epoch_commitments: e.epoch_commitments.as_ref().map(|v| bcs::to_bytes(&v).unwrap()),
