...
use sui_rest_api::{client::BalanceChange, Client, ExecuteTransactionQueryParameters};
...
async fn execute_transaction_transfer() {
    ...
    let mut expected = vec![
        ...
        BalanceChange { address, coin_type: sui_types::gas_coin::GAS::type_tag(), amount: amount as i128 },
    ];
