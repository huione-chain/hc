...
const SUI_DIR: &str = ".hc";
pub const SUI_CONFIG_DIR: &str = "hc_config";
...
pub const SUI_KEYSTORE_FILENAME: &str = "hc.keystore";
pub const SUI_KEYSTORE_ALIASES_FILENAME: &str = "hc.aliases";
