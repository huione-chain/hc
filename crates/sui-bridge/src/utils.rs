...
use crate::{
    ...
    config::{default_ed25519_key_pair, BridgeNodeConfig, EthConfig, MetricsConfig, SuiConfig},
    crypto::{BridgeAuthorityKeyPair, BridgeAuthorityPublicKeyBytes},
    server::APPLICATION_JSON,
    types::{AddTokensOnSuiAction, BridgeAction},
};
use anyhow::anyhow;
use ethers::{
...
pub async fn get_eth_contract_addresses<P: ethers::providers::JsonRpcClient + 'static>(
    ...
    Ok((committee_address, limiter_address, vault_address, config_address, weth_address))
}
