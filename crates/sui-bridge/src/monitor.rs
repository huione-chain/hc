    ...
    async fn handle_sui_events(
        ...
        match event {
            ...
            SuiBridgeEvent::CommitteeMemberUrlUpdateEvent(event) => {
                ...
                .await;
                bridge_auth_agg.store(Arc::new(BridgeAuthorityAggregator::new(Arc::new(new_committee))));
...
mod tests {
    ...
    async fn test_update_bridge_authority_aggregation_with_url_change_event() {
        ...
        let agg = Arc::new(ArcSwap::new(Arc::new(BridgeAuthorityAggregator::new(Arc::new(old_committee)))));
    ...
    async fn test_update_bridge_pause_status_with_emergency_event() {
        ...
        let agg = Arc::new(ArcSwap::new(Arc::new(BridgeAuthorityAggregator::new(Arc::new(committee)))));
        let sui_token_type_tags = Arc::new(ArcSwap::from(Arc::new(HashMap::new())));
        let _handle = tokio::task::spawn(
            BridgeMonitor::new(
                sui_client.clone(),
