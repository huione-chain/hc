...
mod tests {
    ...
    fn test_bridge_sig_verification_regression_test() {
        ...
        let authority1 =
            BridgeAuthority { pubkey: pubkey1.clone(), voting_power: 2500, is_blocklisted: false, base_url: "".into() };
        ...
        let authority2 =
            BridgeAuthority { pubkey: pubkey2.clone(), voting_power: 2500, is_blocklisted: false, base_url: "".into() };
        ...
        let authority3 =
            BridgeAuthority { pubkey: pubkey3.clone(), voting_power: 2500, is_blocklisted: false, base_url: "".into() };
        ...
        let authority4 =
            BridgeAuthority { pubkey: pubkey4.clone(), voting_power: 2500, is_blocklisted: false, base_url: "".into() };
