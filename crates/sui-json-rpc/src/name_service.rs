...
const NAME_SERVICE_DEFAULT_PACKAGE_ADDRESS: &str = "0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0";
const NAME_SERVICE_DEFAULT_REGISTRY: &str = "0xe64cd9db9f829c6cc405d9790bd71567ae07259855f4fba6f02c84f52298c106";
const NAME_SERVICE_DEFAULT_REVERSE_REGISTRY: &str = "0x2fd099e17a292d2bc541df474f9fafa595653848cbabb2d7a4656ec786a1969f";
const _NAME_SERVICE_OBJECT_ADDRESS: &str = "0x6e0ddefc0ad98889c04bab9639e512c21766c5e6366f89e696956d9be6952871";
...
impl Default for NameServiceConfig {
    fn default() -> Self {
        ...
        let reverse_registry_id = ObjectID::from_str(NAME_SERVICE_DEFAULT_REVERSE_REGISTRY).unwrap();
