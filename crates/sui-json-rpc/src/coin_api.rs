...
async fn find_package_object_id(
    ...
    spawn_monitored_task!(async move {
        ...
        let (_, effect) = state.get_executed_transaction_and_effects(publish_txn_digest, kv_store).await?;
...
mod tests {
    ...
    use sui_types::{
        ...
        gas_coin::GAS,
        id::UID,
        messages_checkpoint::{CheckpointContentsDigest, CheckpointDigest, CheckpointSequenceNumber},
        object::Object,
        parse_sui_struct_tag,
