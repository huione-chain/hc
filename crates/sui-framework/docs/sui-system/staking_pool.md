...
<dd>
 ...
 This includes both the principal and rewards HC withdrawn.
</dd>
<dt>
...
Struct representing the exchange rate of the stake pool token to HC.
...
A self-custodial object holding the staked HC tokens.
...
An alternative to <code><a href="staking_pool.md#0x3_staking_pool_StakedSui">StakedSui</a></code> that holds the pool token amount instead of the HC balance.
...
Both the principal and corresponding rewards in HC are withdrawn.
...
Withdraw the principal HC stored in the StakedSui object, and calculate the corresponding amount of pool
tokens using exchange rate at staking epoch.
Returns values are amount of pool tokens withdrawn and withdrawn principal portion of HC.
...
Called at epoch advancement times to add rewards (in HC) to the staking pool.
...
1. Calculates the total amount of HC (including principal and rewards) that the provided pool tokens represent
