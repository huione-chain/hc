...
impl TransactionKeyValueStore {
    ...
    pub async fn multi_get_checkpoints(
        ...
        let num_contents = checkpoint_contents.len() as u64 + checkpoint_contents_by_digest.len() as u64;
    ...
    pub async fn multi_get_checkpoints_summaries(
        ...
        self.multi_get_checkpoints(keys, &[], &[], &[]).await.map(|(summaries, _, _, _)| summaries)
    }
    ...
    pub async fn multi_get_checkpoints_contents(
        ...
        self.multi_get_checkpoints(&[], keys, &[], &[]).await.map(|(_, contents, _, _)| contents)
    }
    ...
    pub async fn multi_get_checkpoints_summaries_by_digest(
        ...
        self.multi_get_checkpoints(&[], &[], keys, &[]).await.map(|(_, _, summaries, _)| summaries)
    }
    ...
    pub async fn multi_get_checkpoints_contents_by_digest(
        ...
        self.multi_get_checkpoints(&[], &[], &[], keys).await.map(|(_, _, _, contents)| contents)
    }
    ...
    pub async fn get_checkpoint_contents_by_digest(
        ...
        self.multi_get_checkpoints_contents_by_digest(&[digest]).await?.into_iter().next().flatten().ok_or(
            SuiError::UserInputError {
                error: UserInputError::VerifiedCheckpointDigestNotFound(format!("{:?}", digest)),
            },
        )
