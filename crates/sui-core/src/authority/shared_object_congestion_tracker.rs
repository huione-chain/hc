...
impl SharedObjectCongestionTracker {
    pub fn new(mode: PerObjectCongestionControlMode, gas_budget_based_txn_cost_cap_factor: Option<u64>) -> Self {
        Self { object_execution_cost: HashMap::new(), mode, gas_budget_based_txn_cost_cap_factor }
    }
    ...
    pub fn new_with_initial_value_for_test(
        ...
        Self { object_execution_cost, mode, gas_budget_based_txn_cost_cap_factor }
    }
...
mod object_cost_tests {
    ...
    fn test_compute_tx_start_at_cost() {
        ...
        let shared_object_congestion_tracker = SharedObjectCongestionTracker::new_with_initial_value_for_test(
    ...
    fn test_bump_object_execution_cost(
        ...
        let mut shared_object_congestion_tracker = SharedObjectCongestionTracker::new_with_initial_value_for_test(
            &[(object_id_0, 5), (object_id_1, 10)],
            mode,
            cap_factor,
        );
