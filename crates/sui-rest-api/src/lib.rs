...
use std::sync::Arc;
use sui_types::{storage::RestStateReader, transaction_executor::TransactionExecutor};
use tap::Pipe;
...
impl RestService {
    pub fn new(reader: Arc<dyn RestStateReader>, software_version: &'static str) -> Self {
        ...
        Self { reader: StateReader::new(reader), executor: None, chain_id, software_version, metrics: None }
    }
