...
impl From<sui_types::sui_system_state::sui_system_state_summary::SuiValidatorSummary> for ValidatorSummary {
    fn from(value: sui_types::sui_system_state::sui_system_state_summary::SuiValidatorSummary) -> Self {
        ...
        Self {
            ...
            protocol_public_key: sui_sdk2::types::Bls12381PublicKey::from_bytes(protocol_pubkey_bytes).unwrap(),
            network_public_key: sui_sdk2::types::Ed25519PublicKey::from_bytes(network_pubkey_bytes).unwrap(),
            worker_public_key: sui_sdk2::types::Ed25519PublicKey::from_bytes(worker_pubkey_bytes).unwrap(),
            proof_of_possession_bytes,
            name,
            description,
            image_url,
