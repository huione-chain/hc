...
use sui_types::{
    ...
    sui_sdk2_conversions::{type_tag_core_to_sdk, SdkTypeConversionError},
};
use tap::Pipe;
...
impl ApiEndpoint<RestService> for GetObject {
    ...
    fn operation(&self, generator: &mut schemars::gen::SchemaGenerator) -> openapiv3::v3_1::Operation {
        OperationBuilder::new()
            ...
            .response(200, ResponseBuilder::new().json_content::<Object>(generator).bcs_content().build())
...
pub async fn get_object(
    ...
    let object = state.get_object(object_id)?.ok_or_else(|| ObjectNotFoundError::new(object_id))?;
...
async fn list_dynamic_fields(
    ...
    match accept {
        AcceptFormat::Json => {}
        _ => return Err(RestError::new(axum::http::StatusCode::BAD_REQUEST, "invalid accept type")),
    }
