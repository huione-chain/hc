...
impl MockCheckpointBuilder {
    pub fn new(previous_checkpoint: VerifiedCheckpoint) -> Self {
        ...
        Self { previous_checkpoint, transactions: Vec::new(), epoch_rolling_gas_cost_summary, epoch }
    }
    ...
    fn build_internal(
        ...
        let summary = CheckpointSummary {
            epoch,
            sequence_number: self.previous_checkpoint.sequence_number.checked_add(1).unwrap(),
            network_total_transactions: self.previous_checkpoint.network_total_transactions + contents.size() as u64,
