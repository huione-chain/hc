...
impl ReadStore for SharedInMemoryStore {
    fn get_checkpoint_by_digest(&self, digest: &CheckpointDigest) -> Result<Option<VerifiedCheckpoint>> {
        self.inner().get_checkpoint_by_digest(digest).cloned().pipe(Ok)
    }
    ...
    fn get_checkpoint_by_sequence_number(
        ...
        self.inner().get_checkpoint_by_sequence_number(sequence_number).cloned().pipe(Ok)
    }
    ...
    fn get_full_checkpoint_contents_by_sequence_number(
        ...
        Ok(self.inner().full_checkpoint_contents.get(&sequence_number).cloned())
    }
...
impl ObjectStore for SharedInMemoryStore {
    fn get_object(&self, _object_id: &crate::base_types::ObjectID) -> Result<Option<crate::object::Object>> {
        todo!()
    }
